...
| Day2 | 互动事件采集、热度聚合、多维榜单、快照 | `InteractionController`、`HeatAggregationTask`、`RankingService`、`SnapshotTask`、`docs/窗口函数实践说明.md`、`docs/互动模拟与榜单变化记录.md` |
...
| Day6 | 架构文档、数据库文档、Demo、互评、PPT | `docs/系统架构说明.md`、`docs/演示手册.md`、`docs/最终检查清单.md`、`docs/答辩演示大纲.md`、`docs/接口测试结果报告.md` |
| Day7 | 项目答辩、追问准备、复盘与演进 | `docs/第七天答辩手册.md`、`docs/答辩演讲稿与项目讲解手册.md`、本交付报告 |
